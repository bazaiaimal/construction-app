  ...
  return (
    <>
      ...
      <div className="row mt-5 p-3">
        ...
        <div
          className="col-sm-12 col-md-10 col-lg-10 mx-auto mt-5"
          style={{ textAlign: "justify" }}
        >
          In addition to creative web design and e-commerce web site design and
          development, MA web design company Interactive Palette offers an
